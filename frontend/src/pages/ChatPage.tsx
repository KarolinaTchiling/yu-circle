...
const ChatUI: React.FC = () => {
  {/* Message list (should be returned through API) */}
  ...
  return (
    <div className="flex flex-col w-full h-screen border rounded-lg overflow-hidden">
      <Header />
      <div className="flex flex-grow p-4 mt-2 rounded-lg space-x-4">
        {/* List Column */}
        <div className="w-1/3 bg-gray-100 border p-4 flex flex-col rounded-lg">
          ...
          <div className="flex-col flex-grow overflow-auto">
            {/* Chat 1 */}
            <div className="p-3 bg-[var(--color-grey)] border rounded-lg mb-2 cursor-pointer"> 
            ...
            {/* Chat 2 */}
            <div className="p-3 bg-gray-200 border rounded-lg mb-2 cursor-pointer">
              <p className="font-bold">Claire</p>
              <p className="text-gray-600 text-sm">LOL I agree that midterm was hard</p>
            </div>
          </div>
          {/* Bottom half of list */}
          <h2 className="text-lg font-bold mt-6">Requests</h2>
          <div className="mt-2 bg-gray-200 p-3 border rounded-lg flex justify-between items-center">
            <div>
        ...
        {/* Chat Window Column */}
        <div className="w-2/3 bg-gray-50 p-4 flex flex-col border rounded-lg">

...
public class ProfileController {
    ...
    public ResponseEntity<String> updateProfilePicture(@PathVariable String username,
    ...
    public ResponseEntity<String> updateUserBio(@PathVariable String username,
            @RequestBody Map<String, String> request) {
    ...
    public ResponseEntity<String> login(@RequestBody Map<String, String> loginRequest) {
        boolean authenticated = profileService.authenticateUser(loginRequest.get("username"),
